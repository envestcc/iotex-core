...
func (fd *fileDAO) GetBlockHash(height uint64) (hash.Hash256, error) {
	...
	return hash.ZeroHash256, errors.Wrap(ErrNotSupported, "failed to get block hash")
}
...
func (fd *fileDAO) HeaderByHeight(height uint64) (*block.Header, error) {
	...
	return nil, errors.Wrap(ErrNotSupported, "failed to get header by height")
}
...
func (fd *fileDAO) FooterByHeight(height uint64) (*block.Footer, error) {
	...
	return nil, errors.Wrap(ErrNotSupported, "failed to get footer by height")
}
...
func (fd *fileDAO) GetReceipts(height uint64) ([]*action.Receipt, error) {
	...
	return nil, errors.Wrap(ErrNotSupported, "failed to get receipts")
}
...
func (fd *fileDAO) TransactionLogs(height uint64) (*iotextypes.TransactionLogs, error) {
	...
	return nil, errors.Wrap(ErrNotSupported, "failed to get transaction logs")
}
